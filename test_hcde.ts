...
async function runTests() {
    ...
    // Provide a dummy ai object
    const ai: any = { models: { generateContent: async () => ({ text: "{}" }) } };
    ...
    const report1 = await hcde.diagnoseMission(ai, { mission_id: "M1", success: false }, mockEvidence);
    ...
    const report2 = await hcde.diagnoseMission(ai, { mission_id: "M2", success: true, criticality: 90 }, mockEvidence);
