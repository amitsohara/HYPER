const fs = require('fs');
const path = 'src/server/core/pipeline/init_society.ts';

const correctCode = `import { HyperMindEventMesh } from "../hcns01/eventMesh.js";
...
fs.writeFileSync(path, correctCode);
