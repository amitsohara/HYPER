...
Return JSON:
{
  ...
  "synthesis_summary": "Summary of AGI synthesis."
    ...
    static async runContinuousLoop(ai: GoogleGenAI) {
        ...
        const obsRes = await generateWithRetry(ai, { model: 'gemini-2.5-flash', contents: observationPrompt, config: { responseMimeType: "application/json" } }, 3);
        ...
        const repRes = await generateWithRetry(ai, { model: 'gemini-2.5-flash', contents: repPrompt, config: { responseMimeType: "application/json" } }, 3);
        ...
        const reasonRes = await generateWithRetry(ai, { model: 'gemini-2.5-flash', contents: reasonPrompt, config: { responseMimeType: "application/json" } }, 3);
        ...
        const hypRes = await generateWithRetry(ai, { model: 'gemini-2.5-flash', contents: hypPrompt, config: { responseMimeType: "application/json" } }, 3);
        ...
        const expRes = await generateWithRetry(ai, { model: 'gemini-2.5-flash', contents: expPrompt, config: { responseMimeType: "application/json" } }, 3);
        ...
        const beliefRes = await generateWithRetry(ai, { model: 'gemini-2.5-flash', contents: beliefPrompt, config: { responseMimeType: "application/json" } }, 3);
