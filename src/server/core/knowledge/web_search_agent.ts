...
export async function webSearch(ai: GoogleGenAI, query: string) {
    const prompt = `Use the Google Search tool to perform a real, up-to-date comprehensive web search for: "${query}".
