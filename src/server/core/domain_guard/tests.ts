...
async function runTests() {
  ...
  console.log("Violations detected:", marsResult.guardMetrics.sectionValidations.map(v => v.wrong_domain_terms).flat());
  ...
  console.log("Violations detected:", startupResult.guardMetrics.sectionValidations.map(v => v.wrong_domain_terms).flat());
  ...
  console.log("Violations detected:", warResult.guardMetrics.sectionValidations.map(v => v.wrong_domain_terms).flat());
  ...
  console.log("Violations detected:", hospitalResult.guardMetrics.sectionValidations.map(v => v.wrong_domain_terms).flat());
